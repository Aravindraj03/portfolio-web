...
function Contact() {
  ...
  const sendEmail = (e) => {
   ...
   //Convert the first letter into the Caps
    ...
    if((e.target[0].value && e.target[2].value && e.target[3].value && e.target[4].value) === "") {
      ...
      toast.success(<p className='toastMessageStyle'> Your Enquiry as Been Successfully 😉🤗👍 </p>);
      e.target.reset();
    }
  ...
  // Sending Email using emailjs library ........
    ...
    //       toast.error(<p className='toastMessageStyle'> error-------------------------------{error.text} </p>);
    //   });
          ...
          <div className="info-container">
            ...
            <div className="box-container">
              ...
              <div className="box">
                ...
                <div className="info">
                  <h3> Address </h3>
                  <p>10A West Naduvankarai, Anana Nagar, Chennai - 600040, Tamil Nadu, India </p>
                </div>
              </div>
            ...
            <div className="share">
              ...
              <a href="#"> <FaGithub className="mediaIcons"/> </a>
            </div>
